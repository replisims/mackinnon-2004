...
\section{Method}
The R code used to run this simulation replication is available at [https://github.com/replisims/mackinnon-2004.git](https://github.com/replisims/mackinnon-2004.git).
